# Getting help with sdcLog

Thanks for using sdcLog. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/sdcLog/issues) to make sure the 
