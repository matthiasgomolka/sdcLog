...
test_that("find_SD_problems() returns a list", {
  expect_type(
    sdcLog:::find_SD_problems(
      extreme_test_dt, head, 5L, "id", "val_1",
      by = NULL
    ),
    "list"
  )
  expect_type(sdcLog:::find_SD_problems(
...
test_that("find_SD_problems() detects problems correctly", {
  ...
  # list[["problems]] == FALSE
  expect_false(sdcLog:::find_SD_problems(
    extreme_test_dt, head, 5L, "id", "val_1",
    by = NULL
  )[["problems"]])
  expect_false(sdcLog:::find_SD_problems(
  ...
  # head, for tail == FALSE
  expect_true(sdcLog:::find_SD_problems(
...
test_that("find_SD() returns correct subset", {
  ...
  expect_identical(
    sdcLog:::find_SD(extreme_test_dt, "min", 5L, "id", "val_1", by = NULL),
    extreme_test_dt[6L:10L, ]
  )
  expect_identical(
    sdcLog:::find_SD(extreme_test_dt, "max", 5L, "id", "val_1", by = NULL),
  ...
  expect_identical(
    sdcLog:::find_SD(extreme_test_dt, "max", 9L, "id", "val_1", by = NULL),
  ...
  expect_identical(
    sdcLog:::find_SD(extreme_test_dt_by, "min", 5L, "id", "val_1", "sector"),
    extreme_test_dt_by[c(6L:10L, 16L:20L), row_order, with = FALSE]
  )
  expect_identical(
    sdcLog:::find_SD(extreme_test_dt_by, "max", 5L, "id", "val_1", "sector"),
