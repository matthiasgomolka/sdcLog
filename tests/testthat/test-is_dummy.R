...
test_that("is_dummy() always returns a logical", {
    expect_type(sdcLog:::is_dummy(constant)  , "logical")
    ...
    expect_type(sdcLog:::is_dummy(dummy_int) , "logical")
    expect_type(sdcLog:::is_dummy(dummy_num) , "logical")
    expect_type(sdcLog:::is_dummy(fake_dummy), "logical")
    expect_type(sdcLog:::is_dummy(complex)   , "logical")
    expect_type(sdcLog:::is_dummy(list)      , "logical")
})

#test that is_dummy_col returns correct for different variables
test_that("is_dummy() classifies correctly", {
    expect_true(sdcLog:::is_dummy(constant)  , "logical")
    expect_true(sdcLog:::is_dummy(character) , "logical")
    expect_true(sdcLog:::is_dummy(factor)    , "logical")
    expect_true(sdcLog:::is_dummy(logical)   , "logical")
    expect_true(sdcLog:::is_dummy(dummy_int) , "logical")
    expect_true(sdcLog:::is_dummy(dummy_num) , "logical")

    expect_false(sdcLog:::is_dummy(integer)   , "logical")
    expect_false(sdcLog:::is_dummy(numeric)   , "logical")
    expect_false(sdcLog:::is_dummy(fake_dummy), "logical")
    expect_false(sdcLog:::is_dummy(complex)   , "logical")
    expect_false(sdcLog:::is_dummy(list)      , "logical")
})
