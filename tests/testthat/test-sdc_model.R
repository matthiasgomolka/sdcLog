...
ref_1 <- structure(
    list(
        ...
        dfs = structure(77L, class = c("sdc_dfs", "integer")),
        terms = list(
            x_1 = structure(
...
test_that("too few distinct id's are handled correctly", {
    ...
    ref_2 <- structure(
        list(
            ...
            dfs = structure(28L, class = c("sdc_dfs", "integer")),
            terms = list(
                x_1 = structure(
...
ref_3 <- structure(
    list(
        ...
        dfs = structure(69L, class = c("sdc_dfs", "integer")),
        terms = list(
            x_1 = structure(
                data.table(x_1 = "<non-zero>", distinct_ids = 10L, key = "x_1"),
                class = c("sdc_distinct_ids", "data.table", "data.frame")
...
test_that("dummy problems are handled correctly", {
    ...
    ref_4 <- structure(
        list(
            ...
            dfs = structure(74L, class = c("sdc_dfs", "integer")),
            terms = list(
                x_1 = structure(
                    data.table(x_1 = "<non-zero>", distinct_ids = 10L, key = "x_1"),
                    class = c("sdc_distinct_ids", "data.table", "data.frame")
...
test_that("interactions are handled correctly", {
    ...
    ref_5 <- structure(
        list(
            ...
            dfs = structure(64L, class = c("sdc_dfs", "integer")),
            terms = list(
                dummy_1 = structure(
...
test_that("interaction with problems is handled correctly", {
    ...
    ref_6 <- structure(
        list(
            ...
            dfs = structure(52L, class = c("sdc_dfs", "integer")),
            terms = list(
...
# problem with DF ----
test_that("too few DF are reported correctly", {
    options(sdc.info_level = 1)
    ref_7 <- structure(
        list(
            options = list_options(),
            settings = list_arguments(id_var = "id"),
            ...
            dfs = structure(7L, class = c("sdc_dfs", "integer")),
            terms = list(
                x_1 = structure(
                    data.table(x_1 = "<non-zero>", distinct_ids = 10L, key = "x_1"),
                    class = c("sdc_distinct_ids", "data.table", "data.frame")
    ...
    subset <- seq(1, 80, by = 8)
    model_7 <- lm(y ~ x_1 + x_2, data = sdc_model_DT[subset])
    summary(model_7)


    expect_warning(
        expect_equal(
            sdc_model(sdc_model_DT[subset], model_7, "id"),
            ref_7,
            ignore_attr = TRUE
        ),
        paste(
    ...
    capture_output(
        print(sdc_model(sdc_model_DT[subset], model_7, "id"))
    )
})
...
test_that("Bug from #79 is solved", {
    ...
    ref_issue_79 <- structure(
        list(
            ...
            dfs = structure(78L, class = c("sdc_dfs", "integer")),
            terms = list(
                x_id = structure(
                    data.table(
